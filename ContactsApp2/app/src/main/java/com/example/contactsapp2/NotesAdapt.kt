...
class NotesAdapt : ListAdapter<Note, NotesAdapt.NoteHolder>(DIFF_CALLBACK)  {
    companion object {
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Note>() {
            ...
            override fun areContentsTheSame(oldItem: ContactsContract.CommonDataKinds.Note, newItem: ContactsContract.CommonDataKinds.Note): Boolean {
